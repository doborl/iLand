...
// STP3  planting_3 = planting for site 3 acidic soils 40% Quercus petreae L. ( Sessile oak) and 60% Pinus sylvestris L. (Scotch pine).
...
// STP5 planting_5 = planting for site 5 rich soils 60% Picea abies L. (Norway sprunce) and 40% Fagus sylvatica L. (European beech).
...
// STP7 planting_7a = planting for site 7a partially waterlock soil 60% Picea abies L. (Norway sprunce) and 40% Quercus petra L. (Sessile oak).
...
// STP9 planting_7b = planting for site 7b waterlock soil 100% Alnus glutinosa L. (European alder).
...
var thinning11 = { type: "thinning", 
				   ...
				   targetValue: 25,  targetVariable: "volume", targetRelative: true,  minDbh: 0,
...
var thinning31 = { type: "thinning", 
				   schedule: { minRel: 0.09, optRel: 0.10, maxRel: 0.11 , force=true},
                                   ...
                                   thinning: "custom",
				   onEvaluate: function() { console.log("1st THINNING ");return true;},
				   targetValue: 30,  targetVariable: "volume", targetRelative: true,  minDbh: 0,
				   classes: [30, 30, 20, 10, 10]
}
...
var thinning51 = { type: "thinning", 
				   schedule: { minRel: 0.09, optRel: 0.10, maxRel: 0.11 , force=true},
                                   ...
                                   thinning: "custom",
				   onEvaluate: function() { console.log("1st THINNING ");return true;},
				   targetValue: 40,  targetVariable: "volume", targetRelative: true,  minDbh: 0,
...
var thinning71a = { type: "thinning", 
				   schedule: { minRel: 0.09, optRel: 0.10, maxRel: 0.11 , force=true},
                                   ...
                                   thinning: "custom",
				   onEvaluate: function() { console.log("1st THINNING ");return true;},
				   targetValue: 45,  targetVariable: "volume", targetRelative: true,  minDbh: 0,
				   classes: [10, 20, 25, 25, 20]
}
...
var thinning77b = { type: "thinning", 
				   schedule: { minRel: 0.69, optRel: 0.70, maxRel: 0.71 , force=true},
                                   ...
                                   thinning: "custom",
				   onEvaluate: function() { console.log("7th THINNING ");return true;},
				   targetValue: 10,  targetVariable: "volume", targetRelative: true,  minDbh: 5,
				   classes: [30, 30, 30, 10, 0]
}
...
stp: {  'STP1': 'STP1' ,'STP3': 'STP3', 'STP5': 'STP5','STP7': 'STP7','STP9': 'STP9','default':'STP5' },
