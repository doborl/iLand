############################################ BASE ON STEMS REMOVAL WITH HEIGHT CONSTRAINS ##################################################
## JAVA SCRIPT
/*
...
var a_thinning31 = { type: "thinning", 
				   ...
				   onEvaluate: function() { console.log("1st THINNING ");return true;},
				    remainingStems: 4200, targetValue: 100,  minDbh: 5,
...
var a_thinning32 = { type: "thinning", 
				   ...
				   onEvaluate: function() { console.log("2nd THINNING ");return true;},
				    remainingStems: 2940, targetValue: 100,  minDbh: 5,
				   classes: [30, 30, 20, 10, 10]
}
...
var a_thinning33 = { type: "thinning", 
				   ...
				   remainingStems: 2205, targetValue: 100,  minDbh: 5,
...
var a_thinning34 = { type: "thinning", 
				   ...
				   remainingStems: 1654, targetValue: 100,  minDbh: 5,
				   classes: [30, 30, 30, 10, 0]
}
...
var a_thinning35 = { type: "thinning", 
				   ...
				   remainingStems: 1323, targetValue: 100,  minDbh: 5,
				   classes: [30, 30, 30, 10, 0]
}
...
var a_thinning36 = { type: "thinning", 
				   ...
				   remainingStems: 1058, targetValue: 100,  minDbh: 5,
				   classes: [30, 30, 30, 10, 0]
}
...
var a_thinning37 = { type: "thinning", 
				   ...
				   remainingStems: 900, targetValue: 100,  minDbh: 5,
				   classes: [30, 30, 30, 10, 0]
}
...
var a_thinning38 = { type: "thinning", 
				   ...
				   remainingStems: 765, targetValue: 100,  minDbh: 5,
				   classes: [30, 30, 30, 10, 0]
}
...
var a_thinning3_sw1 = { type: "thinning", 
				   ...
				   constraint: ["stand.topHeight>0"],
                                   thinning: "custom",
				   onEvaluate: function() { console.log("1st THINNING ");return true;},
				   remainingStems: 380, targetValue: 100,  minDbh: 5,
...
_____________________________________________________ SECOND PART OF THE SCRIPT IN XML FOR THE PROJECT FILE IlAND  XML SCRIPT____________________________________
...
_______________________________________________________________________________________________________________________________________________________________-
	__________________________________JAVA SCRIPT IMPLEMENTATION OF MANAGEMENT ALTERNATIVE WITHOUT THE HEIGHT CONSTRAINS _________________________________
...
//- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- 
//                                                      ---   F I N A L C U T S  --->   we could delate the final cut just putting another thinning and shelterwood here
...
// minimal agent type, it could be delate
var base_agent = {
	scheduler: { 
		 enabled: true,
                 minScheduleHarvest: 1,
